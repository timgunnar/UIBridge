...
class TestInstallState:
    ...
    def test_key_modules_importable(self):
        ...
        modules = [
            ...
            "uibridge.mcp.server",
            "uibridge.mcp.state",
            "uibridge.mcp.helpers",
            "uibridge.browser",
            "uibridge.browser.recorder",
            "uibridge.browser.recorder_js",
            "uibridge.browser.state",
            "uibridge.browser.self_test",
            "uibridge.browser.dom_diff",
            "uibridge.browser.ir",
            "uibridge.generator",
            "uibridge.generator.style_learner",
