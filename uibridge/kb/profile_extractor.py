"""Project profile extractor — Phase 1 project profiling and extended inference."""
...
# ── Stub classes (profile.py deleted in v0.4.0, moved to scanner/) ──

class ProfileField:
    """Stub: framework profile field. Moved to scanner/ProjectProfile in v0.4.0."""
    def __init__(self, value=None, source="auto", confidence=0.5, description=""):
        self.value = value
        self.source = source
    ...
    @classmethod
    def from_dict(cls, d):
        return cls(value=d.get("value"), source=d.get("source", "auto"),
                   confidence=d.get("confidence", 0.5), description=d.get("description", ""))

    def __eq__(self, other):
        if not isinstance(other, ProfileField):
            return NotImplemented
        return (self.value == other.value and self.source == other.source and
                self.confidence == other.confidence and self.description == other.description)


class FrameworkProfile:
    """Stub: framework profile. Moved to scanner/ProjectProfile in v0.4.0."""
    def __init__(self, **kwargs):
        self.project_type = kwargs.pop("project_type", "")
        self.total_java_files = kwargs.pop("total_java_files", 0)
        self.total_py_files = kwargs.pop("total_py_files", 0)
        self.ui_packages = kwargs.pop("ui_packages", ProfileField())
        self.base_classes = kwargs.pop("base_classes", ProfileField())
        self.annotations = kwargs.pop("annotations", ProfileField())
        self.locator_priorities = kwargs.pop("locator_priorities", ProfileField())
        self.naming_conventions = kwargs.pop("naming_conventions", ProfileField())
        self.source_dirs = kwargs.pop("source_dirs", ProfileField())
        self.layer_structure = kwargs.pop("layer_structure", ProfileField())
        self.reference_directories = kwargs.pop("reference_directories", ProfileField())
        self.output_config = kwargs.pop("output_config", ProfileField())
        self.component_monitoring = kwargs.pop("component_monitoring", ProfileField())
        self.profiling_confidence = kwargs.pop("profiling_confidence", 0.5)
        self.updated_by = kwargs.pop("updated_by", "")
        self.ui_relevant_files = kwargs.pop("ui_relevant_files", 0)
    ...
    def to_dict(self):
        return {
            ...
            "ui_relevant_files": self.ui_relevant_files,
        }
    ...
    def from_dict(cls, d):
        return cls(
            ...
            total_java_files=d.get("total_java_files", 0),
            total_py_files=d.get("total_py_files", 0),
            ...
            ui_relevant_files=d.get("ui_relevant_files", 0),
        )
