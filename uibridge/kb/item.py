...
class KBItem:
    ...
    source_file: str = ""            # single source file (legacy per-file items)
    source_files: list[str] = field(default_factory=list)  # multiple sources (aggregated items)
    aggregation: str = ""            # "" | "component_family" | "page_index" | "convention_batch" | "pattern_mined"
